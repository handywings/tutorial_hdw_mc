...
$("#exportPdf").click(function () {
	...
	var embedPdf = '<iframe class="card" src="${pageContext.request.contextPath}/customerreport/byservicetype/exportPdf/reportrange/'+reportrange+'/servicePackageType/'+servicePackageType+'/customerFeature/'+customerFeature+'" width="100%" height="500" type="application/pdf" />';
