...
$("#exportPdf").click(function () {
	...
	var embedPdf = '<iframe class="card" src="${pageContext.request.contextPath}/customerreport/byworksheetcancel/exportPdf/reportrange/'+reportrange+'/displayFormat/'+displayFormat+'/sortingStyle/'+sortingStyle+'" width="100%" height="500" type="application/pdf" />';
