...
<c:set var="subMenu" value="byworksheetmove" scope="request"/>

<!DOCTYPE html>
<html lang="en">
<head>
<title>รายงานทะเบียนลูกค้าที่แจ้งย้ายสาย</title>
			...
			<div class="content-area py-1">
				<div class="container-fluid">
					<div class="row mt05 mb05" >
						<div class="col-md-12">
							<h3>รายงานทะเบียนลูกค้าที่แจ้งย้ายสาย</h3>
							<ol class="breadcrumb no-bg mb-1">
								<li class="breadcrumb-item active">รายงานทะเบียนลูกค้า</li>
								<li class="breadcrumb-item active">รายงานทะเบียนลูกค้าที่แจ้งย้ายสาย</li>
							</ol>
						</div>
					</div>
						...
						<div class="col-md-3">
							<div class="card mt05">
								<div class="card-header text-uppercase">
									<h4>
										<i class="zmdi zmdi-search"></i>&nbsp;ระบุข้อมูล
									</h4>
								</div>
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<select class="form-control" id="sortingStyle">
															...
															<option value="2">จัดเรียงตามวันที่แจ้งย้ายสาย</option>
														</select>
													</div>													
												</div>
											</div>
...
$("#exportPdf").click(function () {
	...
	var embedPdf = '<iframe class="card" src="${pageContext.request.contextPath}/customerreport/byworksheetmove/exportPdf/reportrange/'+reportrange+'/sortingStyle/'+sortingStyle+'" width="100%" height="500" type="application/pdf" />';
