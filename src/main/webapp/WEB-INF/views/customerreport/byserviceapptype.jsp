...
<c:set var="subMenu" value="byserviceapptype" scope="request"/>


<!DOCTYPE html>
<html lang="en">
<head>
<title>รายงานทะเบียนลูกค้าตามประเภทใบสมัคร</title>
			...
			<div class="content-area py-1">
				<div class="container-fluid">
					<div class="row mt05 mb05" >
						<div class="col-md-12">
							<h3>รายงานทะเบียนลูกค้าตามประเภทใบสมัคร</h3>
							<ol class="breadcrumb no-bg mb-1">
								<li class="breadcrumb-item active">รายงานทะเบียนลูกค้า</li>
								<li class="breadcrumb-item active">รายงานทะเบียนลูกค้าตามประเภทใบสมัคร</li>
							</ol>
						</div>
					</div>
						...
						<div class="col-md-3">
							<div class="card mt05">
								<div class="card-header text-uppercase">
									<h4>
										<i class="zmdi zmdi-search"></i>&nbsp;ระบุประเภทใบสมัคร
									</h4>
								</div>
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														<label for="year"><b>ประเภทใบสมัคร</b></label> 
														<select class="form-control" id="serviceApplicationType">
															<option value="0" selected="selected">--- แสดงข้อมูลทุกประเภทใบสมัคร ---</option>
...
$("#exportPdf").click(function () {
	...
	var serviceApplicationType = $("#serviceApplicationType").val();

	var embedPdf = '<iframe class="card" src="${pageContext.request.contextPath}/customerreport/byserviceapptype/exportPdf/reportrange/'+reportrange+'/serviceApplicationType/'+serviceApplicationType+'" width="100%" height="500" type="application/pdf" />';
