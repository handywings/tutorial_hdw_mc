...
$("#exportPdf").click(function () {
	...
	var embedPdf = '<iframe class="card" src="${pageContext.request.contextPath}/customerreport/bycondition/exportPdf/reportrange/'+reportrange+'/zone/'+zone+'/career/'+career+'/customerType/'+customerType+'" width="100%" height="500" type="application/pdf" />';
