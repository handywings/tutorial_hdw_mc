...
$("#exportPdf").click(function () {
	...
	var embedPdf = '<iframe class="card" src="${pageContext.request.contextPath}/worksheetreport/worksheetlist/exportPdf/reportrange/'+reportrange+'/jobType/'+jobType+'/worksheetStatus/'+worksheetStatus+'/zone/'+zone+'/split/'+split+'" width="100%" height="500" type="application/pdf" />';
