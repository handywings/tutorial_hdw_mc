...
$("#exportPdf").click(function () {
	...
	var embedPdf = '<iframe class="card" src="${pageContext.request.contextPath}/stockreport/stocksummary/exportPdf/equipmentProductType/'+equipmentProductType+'/equipmentStock/'+equipmentStock+'/split/'+split+'" width="100%" height="500" type="application/pdf" />';
