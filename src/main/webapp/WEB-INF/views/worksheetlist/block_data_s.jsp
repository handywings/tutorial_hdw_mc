...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
					...
					<div class="tab-pane card mb40 <c:if test="${worksheetSearchBean.tab eq 'S'}">active</c:if>" id="block_data_s" role="tabpanel"
						aria-expanded="true">
						<div class="card-header text-uppercase">
							<div class="row mt05">
								<div class="col-md-5">
									<h4><img src="${pageContext.request.contextPath}/resources/assets/img/status-icon/task/checked.png" style="width: 20px;">&nbsp;รายการใบงานที่เสร็จเรียบร้อย</h4>
								</div>
...
<c:choose>
														...
														<c:forEach var="workSheetBean" items="${pagination_s.dataListBean}" varStatus="i">
														<tr>
															<td>
																<center>
														...
														<c:otherwise>
															<tr><td colspan="7"><center>รายการใบงานที่เสร็จเรียบร้อย</center></td></tr>
