											...
											<table class="table table-bordered table-hover" id="tableEquipmentProductChildRepair">
												<thead class="thead-default">
													<tr>
														...
														<th style="vertical-align: middle;"><cetner>Serial Number</cetner></th>
														<th style="vertical-align: middle;"><cetner>จำนวนรับเข้า</cetner></th>
														<th style="vertical-align: middle;"><cetner>เอกสารอ้างอิง</cetner></th>
													</tr>
												</thead>
...
function openViewModalRepair(equipmentProductId,idRef){
	...
	function autoRepair(){
		...
		$(".c_repair_hidden_eItem_id").each(function(index) {
			...
			RepairMatchItemBean.oldItemId = $('#hiddenOldItem'+idRef).val();
		...
		$.ajax({
			type : "POST",
			contentType : "application/json; charset=utf-8",
			url : "${pageContext.request.contextPath}/worksheetlist/autoRepair/",
			dataType : 'json',
