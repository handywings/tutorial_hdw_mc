								...
								<div class="row">
									<div class="col-md-12">
										<div class="row">
											<div class="col-md-12">
												<fieldset>
													<legend>&nbsp;&nbsp;&nbsp;รายละเอียดใบงานลดจุดบริการ&nbsp;&nbsp;&nbsp;</legend>
													<div class="row">
														<div class="col-md-12">
															<input type="hidden" id="hiddenWorksheetReducePointId"
																value="${worksheetBean.reducePointWorksheetBean.id}" />
																		...
																		<table class="table table-bordered mb-0 table-hover">
																			...
																			<tbody>
																				<tr>
																					...
																					<td><center>
																							<span id="c_rp_original_point_all"></span> จุด
																						</center></td>
																					<td><center>
																							<span id="c_rp_original_point_degital"></span>
																							จุด
																						</center></td>
																					<td><center>
																							<span id="c_rp_original_point_analog"></span>
																							จุด
																						</center></td>
																				</tr>
																				<tr>
																					...
																					<td><center>
																							<span id="c_rp_new_point_all">${worksheetBean.reducePointWorksheetBean.digitalPoint+worksheetBean.reducePointWorksheetBean.analogPoint}</span> จุด
																						</center></td>
																					<td><center>
																							<div class="input-group">
																								<input type="number" class="form-control worksheetViewDisableDom"
																									value="${worksheetBean.reducePointWorksheetBean.digitalPoint}" style="text-align: center;"
																									id="c_rp_new_point_degital"
																									onblur="rp_calPoint()">
																					...
																					<td><center>
																							<div class="input-group">
																								<input type="number" class="form-control worksheetViewDisableDom"
																									value="${worksheetBean.reducePointWorksheetBean.analogPoint}" style="text-align: center;"
																									id="c_rp_new_point_analog"
																									onblur="rp_calPoint()">
																								<div class="input-group-addon">จุด</div>
																							</div>
																						</center></td>
																				...
																				<tr>
																					...
																					<td><center>
																							<span id="c_rp_balancel_all"></span> จุด
																						</center></td>
																					<td><center>
																							<span id="c_rp_balance_degital"></span> จุด
																						</center></td>
																					<td><center>
																							<span id="c_rp_balance_analog"></span> จุด
																						</center></td>
																				</tr>
																			</tbody>
																		</table>
															...
															<div class="row mb05">
																<div class="col-md-12">
																	<div>
																		<label for="jobType"><b>ส่วนลดรายเดือน
																				(นับจากบิลถัดไป)</b></label>
																		<div class="input-group">
																			<input id="c_rp_monthlyFree" type="number" min="1"
																				value="${worksheetBean.reducePointWorksheetBean.monthlyFree}" class="form-control worksheetViewDisableDom">
								...
								<c:if test="${worksheetBean.status.stringValue ne 'S' && worksheetBean.status.stringValue ne 'D' && worksheetBean.status.stringValue ne 'R' }">
										<div class="row mt15 mb15">
											<div class="col-md-12">
												<center>
													<perm:permission object="M31.edit">
														<button type="button" onclick="openModalUpdate('C_RP');"
															class="btn btn-success btn-rounded label-left b-a-0 waves-effect waves-light">
															<span class="btn-label"><i class="ti-check"></i></span>
															บันทึกใบงาน
														</button>
...
//	 		timePickerIncrement: 30,
	...
	function addJobDetails(){
		...
		function updateWorksheetReduce(typeSave) {
			var snapHead = {};
			var worksheetUpdateSnapShotBean = setDataHeader(snapHead, typeSave);
			var reducePointWorksheetBean = {};
			reducePointWorksheetBean.id = $('#hiddenWorksheetReducePointId').val();
			...
			worksheetUpdateSnapShotBean.reducePointWorksheetBean = reducePointWorksheetBean;
			worksheetUpdateSnapShotBean.typeWorksheet = "C_RP";
