...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
					...
					<div class="tab-pane card mb40 <c:if test="${worksheetSearchBean.tab eq 'R'}">active</c:if>" id="block_data_r" role="tabpanel"
						aria-expanded="true">
						<div class="card-header text-uppercase">
							<div class="row mt05">
								<div class="col-md-5">
									<h4><img src="${pageContext.request.contextPath}/resources/assets/img/status-icon/task/wrench.png" style="width: 20px;">&nbsp;รายการใบงานอยู่ระหว่างดำเนินงาน</h4>
								</div>
...
<c:choose>
														<c:when test="${pagination_r.dataListBean.size() > 0}">
															<c:forEach var="workSheetBean" items="${pagination_r.dataListBean}" varStatus="i">
														<tr>
															<td>
																<center>
														...
														<c:otherwise>
															<tr><td colspan="7"><center>ไม่พบรายการใบงานอยู่ระหว่างดำเนินงาน</center></td></tr>
								...
								<c:if test="${pagination_r.dataListBean.size() > 0}"></c:if>
								<jsp:include page="paging/paging_r.jsp"></jsp:include>
							</div>
						</div>
					</div>
