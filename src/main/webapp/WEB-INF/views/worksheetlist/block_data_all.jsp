...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
					...
					<div class="tab-pane card mb40 <c:if test="${worksheetSearchBean.tab eq 'All'}">active</c:if>" id="block_data_all" role="tabpanel"
						aria-expanded="true">
						<div class="card-header text-uppercase">
							<div class="row mt05">
								<div class="col-md-5">
									<h4><i class="zmdi zmdi-format-list-bulleted"></i>&nbsp;รายการใบงานทั้งหมด</h4>
								</div>
						...
						<div class="posts-list posts-list-1 mb40">
							<div class="pl-item">
											...
											<table class="table table-bordered mb-0 table-hover" >
												<thead class="thead-default">
													<tr>
														...
														<th style="vertical-align: middle;" width="50px;"><center>สถานะ</center></th>
												...
												<c:choose>
														...
														<tr <c:if test="${workSheetBean.status.stringValue eq 'D'}"> style=" background-color: rgba(233, 30, 99, 0.06); " </c:if>>
															<td>
																<center>
														...
														<c:otherwise>
															<tr><td colspan="7"><center>ไม่พบรายการใบงาน</center></td></tr>
