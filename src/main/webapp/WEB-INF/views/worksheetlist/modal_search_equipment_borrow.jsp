					...
					<div class="col-md-4">
						<div class="">
							<label for="exampleInputEmail1"><b>รหัสสินค้า
								...
								id="c_borrow_keySearchEquipmentProduct" placeholder="ระบุรหัส หรือชื่อสินค้า...">
						</div>
					</div>
					<div class="col-md-3">
						<div class="">
											...
											<table class="table table-bordered mb-0 table-hover" id="c_borrow_tableEquipmentProductChild">
												<thead class="thead-bg">
													<tr>
														...
														<th style="vertical-align: middle;"><center>Serial Number</cetner></th>
														<th style="vertical-align: middle;"><center>จำนวนรับเข้า</cetner></th>
														<th style="vertical-align: middle;"><center>เอกสารอ้างอิง</cetner></th>
													</tr>
												</thead>
...
// 									  "<input type='number' min='0' class='form-control borrowInput' value='" + data["result"]["equipmentProductItemBeans"][i].salePrice + "' id='exampleInputAmount'>"+
// 									  "<div class='input-group-addon'>บาท</div></div></td>";

				var columnSalePrice = "<td class='td-middle'><div class='input-group'>"+
									  "<input type='number' min='0' class='form-control borrowInput' value='0.00' id='exampleInputAmount'>"+
									  "<div class='input-group-addon'>บาท</div></div></td>";
			...
			$(".c_borrow_removeProductItem").click(
					function() {
						...
						BorrowautoInsertAndDeleteData();

					});
			
			$(document).on('blur', '.borrowInput', function(event) {
				BorrowautoInsertAndDeleteData();
			});
	...
	// ลบ row
	$(".c_borrow_removeProductItem").click(function() {
				$(this).closest('tr').remove();
	...
	function BorrowautoInsertAndDeleteData(){
		...
		$.ajax({
			type : "POST",
			contentType : "application/json; charset=utf-8",
			url : "${pageContext.request.contextPath}/worksheetlist/borrowInsertAndUpdateEquipmentProductItem/",
			dataType : 'json',
