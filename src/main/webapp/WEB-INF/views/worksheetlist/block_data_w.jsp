...
<div
	class="tab-pane card mb40 <c:if test="${worksheetSearchBean.tab eq 'W'}">active</c:if>"
	id="block_data_w" role="tabpanel" aria-expanded="true">
	<div class="card-header text-uppercase">
		<div class="row mt05">
			<div class="col-md-5">
				<h4><img src="${pageContext.request.contextPath}/resources/assets/img/status-icon/task/hourglass.png" style="width: 20px;">&nbsp;รายการใบงานรอมอบหมายงาน</h4>
			</div>
	...
	<div class="posts-list posts-list-1">
		<div class="pl-item">
					...
					<div class="table-responsive">
						<table class="table table-bordered mb-0 table-hover">
							...
							<tbody>
								...
								<c:choose>
									<c:when test="${pagination_w.dataListBean.size() > 0}">
										<c:forEach var="workSheetBean"
											items="${pagination_w.dataListBean}" varStatus="i">
											<tr>
												<td>
													<center>
												...
												<td><c:forEach var="addressBean"
													...
													</c:forEach><font style="color: gray;">&nbsp;${workSheetBean.serviceApplication.customer.customerFeatureBean.customerFeatureName}</font>
												</td>
												<td><center>
														<c:choose>
									...
									<c:otherwise>
										<tr>
											<td colspan="7"><center>ไม่พบรายการใบงานรอมอบหมายงาน</center></td>
										</tr>
									</c:otherwise>
								</c:choose>
			...
			<c:if test="${pagination_w.dataListBean.size() > 0}"></c:if>
			<jsp:include page="paging/paging_w.jsp"></jsp:include>
		</div>
	</div>
</div>
