...
<div id="newcustomers">
	<div class="row">
		...
		<div class="col-md-3">
			...
			<input type="text" class="form-control" id="prefix" value="${serviceApplicationBean.customer.prefix}">
		</div>
<!-- 		<div class="col-md-6"> -->
<!-- 			<label for=""><b>บริษัท<span class="text-red"> *</span></b></label> <select -->
<!-- 				class="form-control" id="edit-company" name="edit_company"> -->
...
<!-- 		</div> -->
		<div class="col-md-3">
			<input type="hidden" class="form-control" id="customerId" value="${serviceApplicationBean.customer.id }">
			<label for="exampleInputEmail1"><b>ชื่อ<span class="text-red"> *</span></b></label> 
			<input type="text" class="form-control" id="firstName" value="${serviceApplicationBean.customer.firstName }">
		</div>
		<div class="col-md-3">
			<label for="exampleInputEmail1"><b>นามสกุล<span class="text-red"> *</span></b></label> 
			<input type="text" class="form-control" id="lastName" value="${serviceApplicationBean.customer.lastName }">
		</div>
		<div class="col-md-2">
	...
	<div class="row">
		<div class="col-md-2">
			...
			<input type="text" class="form-control" id="identityNumber" value="${serviceApplicationBean.customer.identityNumber }" >
		</div>
		<div class="col-md-4">
		...
		<div class="col-md-2">
			...
			<input type="text" class="form-control" id="mobile" value="${serviceApplicationBean.customer.contact.mobile }">
		</div>
		<div class="col-md-2">
			<label for="exampleInputEmail1"><b>Fax</b></label> 
			<input type="text" class="form-control" id="fax" value="${serviceApplicationBean.customer.contact.fax }">
		</div>
		<div class="col-md-2">
			<label for="exampleInputEmail1"><b>E-mail<span class="text-red"> *</span></b></label> 
			<input type="text" class="form-control" id="email" value="${serviceApplicationBean.customer.contact.email }">
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-2">
			<input type="hidden" id="addressId1" value="${addressBean.id}">
			<label for="exampleInputEmail1"><b>บ้านเลขที่<span class="text-red"> *</span></b></label> 
			<input type="text" class="form-control" id="no1" value="${addressBean.no}">
		</div>
		<div class="col-md-1">
			<label for="exampleInputEmail1"><b>หมู่ที่</b></label> 
			<input type="text" class="form-control" id="section1" value="${addressBean.section}">
		</div>
		<div class="col-md-3">
			<label for="exampleInputEmail1"><b>อาคาร</b></label> 
			<input type="text" class="form-control" id="building1" value="${addressBean.building}">
		</div>
		<div class="col-md-1">
			<label for="exampleInputEmail1"><b>เลขที่ห้อง</b></label> 
			<input type="text" class="form-control" id="room1" value="${addressBean.room}">
		</div>
		<div class="col-md-1">
			<label for="exampleInputEmail1"><b>ชั้นที่</b></label> 
			<input type="text" class="form-control" id="floor1" value="${addressBean.floor}">
		</div>
		<div class="col-md-4">
			<label for="exampleInputEmail1"><b>หมู่บ้าน</b></label> 
			<input type="text" class="form-control" id="village1" value="${addressBean.village}">
		</div>
		<div class="col-md-3">
			<label for="exampleInputEmail1"><b>ตรอกซอย</b></label> 
			<input type="text" class="form-control" id="alley1" value="${addressBean.alley}">
		</div>
		<div class="col-md-3">
			<label for="exampleInputEmail1"><b>ถนน</b></label> 
			<input type="text" class="form-control" id="road1" value="${addressBean.road}">
		</div>
		<div class="col-md-3">
		...
		<div class="col-md-3">
			...
			<select class="form-control" id="amphur1" name="amphur1">
	...
	<div class="row">
		...
		<div class="col-md-3">
			...
			<input class="form-control bg-form" type="text" id="postcode1" name="postcode1" value="${addressBean.postcode}">
		</div>
		<div class="col-md-6">
			<label for="exampleInputEmail1"><b>สถานที่ใกล้เคียง</b></label>
			<input type="text" class="form-control" id="nearbyPlaces1" value="${addressBean.nearbyPlaces}">
		</div>
	</div>
	</c:if>
	</c:forEach>						
	...
	<div class="row">
		<div class="col-md-2">
			<label for="exampleInputEmail1"><b>บ้านเลขที่<span class="text-red"> *</span></b></label> 
			<input type="hidden" id="addressId2" value="${addressBean.id}">
			<input type="text" class="form-control" id="no2" value="${addressBean.no}">
		</div>
		<div class="col-md-1">
			<label for="exampleInputEmail1"><b>หมู่ที่</b></label> 
			<input type="text" class="form-control" id="section2" value="${addressBean.section}">
		</div>
		<div class="col-md-3">
			<label for="exampleInputEmail1"><b>อาคาร</b></label> 
			<input type="text" class="form-control" id="building2" value="${addressBean.building}">
		</div>
		<div class="col-md-1">
			<label for="exampleInputEmail1"><b>เลขที่ห้อง</b></label> 
			<input type="text" class="form-control" id="room2" value="${addressBean.room}">
		</div>
		<div class="col-md-1">
			<label for="exampleInputEmail1"><b>ชั้นที่</b></label> 
			<input type="text" class="form-control" id="floor2" value="${addressBean.floor}">
		</div>
		<div class="col-md-4">
			<label for="exampleInputEmail1"><b>หมู่บ้าน</b></label> 
			<input type="text" class="form-control" id="village2" value="${addressBean.village}">
		</div>
		<div class="col-md-3">
			<label for="exampleInputEmail1"><b>ตรอกซอย</b></label> 
			<input type="text" class="form-control" id="alley2" value="${addressBean.alley}">
		</div>
		<div class="col-md-3">
			<label for="exampleInputEmail1"><b>ถนน</b></label> 
			<input type="text" class="form-control" id="road2" value="${addressBean.road}">
		</div>
		<div class="col-md-3">
			<label for="exampleInputEmail1"><b>จังหวัด<span class="text-red"> *</span></b></label> 
	...
	<div class="row no-current-address">
		...
		<div class="col-md-3">
			<label for="exampleInputEmail1"><b>รหัสไปรณีย์<span class="text-red"> *</span></b></label>
			<input class="form-control bg-form" type="text" id="postcode2" name="postcode2" value="${addressBean.postcode}">
		</div>
		<div class="col-md-6">
			<label for="exampleInputEmail1"><b>สถานที่ใกล้เคียง</b></label>
			<input type="text" class="form-control" id="nearbyPlaces2" value="${addressBean.nearbyPlaces}">
		</div>
	</div>								
	<!-- ที่อยู่ -->
	</fieldset>
