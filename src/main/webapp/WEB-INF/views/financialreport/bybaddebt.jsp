...
<c:set var="subMenu" value="bybaddebt" scope="request"/>

<!DOCTYPE html>
<html lang="en">
<head>
<title>รายงานการเงินที่เป็นหนี้สูญ</title>
			...
			<div class="content-area py-1">
				<div class="container-fluid">
					<div class="row mt05 mb05" >
						<div class="col-md-12">
							<h3>รายงานการเงินที่เป็นหนี้สูญ</h3>
							<ol class="breadcrumb no-bg mb-1">
								<li class="breadcrumb-item active">รายงานการเงิน</li>
								<li class="breadcrumb-item active">รายงานการเงินที่เป็นหนี้สูญ</li>
							</ol>
						</div>
					</div>
...
$("#exportPdf").click(function () {
	...
	var embedPdf = '<iframe class="card" src="${pageContext.request.contextPath}/financialreport/bybaddebt/exportPdf/reportrange/'+reportrange+'/split/'+split+'" width="100%" height="500" type="application/pdf" />';
