...
<c:set var="subMenu" value="byinvoicetype" scope="request"/>

<!DOCTYPE html>
<html lang="en">
<head>
<title>รายงานการเงินแยกตามใบแจ้งหนี้</title>
			...
			<div class="content-area py-1">
				<div class="container-fluid">
					<div class="row mt05 mb05" >
						<div class="col-md-12">
							<h3>รายงานการเงินแยกตามใบแจ้งหนี้</h3>
							<ol class="breadcrumb no-bg mb-1">
								<li class="breadcrumb-item active">รายงานการเงิน</li>
								<li class="breadcrumb-item active">รายงานการเงินแยกตามใบแจ้งหนี้</li>
							</ol>
						</div>
					</div>
											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														<label for="year"><b>เลือกประเภทใบแจ้งหนี้</b></label> 
														<select class="form-control" id="invoiceType">
															<option value="0" selected="selected">--- แสดงข้อมูลทุกประเภท ---</option>
															<option value="S">ใบแจ้งหนี้ติดตั้งใหม่</option>
															<option value="O">ใบแจ้งหนี้ตามรอบบิล</option>
															<option value="R">ใบแจ้งหนี้งานซ่อม</option>
														</select>
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
														<label for="year"><b>เลือกสถานะการชำระเงิน</b></label> 
														<select class="form-control" id="invoiceStatus">
															<option value="0" selected="selected">--- แสดงข้อมูลทุกสถานะ ---</option>
															<option value="S">บิลชำระเงินเรียบร้อย</option>
															<option value="W">บิลรอชำระ</option>
															<option value="O">บิลค้างชำระ (เกินกำหนดชำระ)</option>
															<option value="C">บิลยกเลิก</option>
														</select>
													</div>
												</div>
												<div class="col-md-12">
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<select class="form-control" id="split">
															<option value="0" selected="selected">แยกตามพนักงานเก็บเงิน</option>
															<option value="1">แยกตามเขตชุมชนพื้นที่ติดตั้ง</option>
															<option value="2">แยกตามประเภทบริการ</option>
															<option value="3">แยกตามรายเดือน</option>
															<option value="4">แยกตามลักษณะสมาชิก</option>
														</select>
													</div>
												</div>
											</div>
...
$("#exportPdf").click(function () {
	...
	var embedPdf = '<iframe class="card" src="${pageContext.request.contextPath}/financialreport/byinvoicetype/exportPdf/reportrange/'+reportrange+'/invoiceType/'+invoiceType+'/split/'+split+'/invoiceStatus/'+invoiceStatus+'" width="100%" height="500" type="application/pdf" />';
