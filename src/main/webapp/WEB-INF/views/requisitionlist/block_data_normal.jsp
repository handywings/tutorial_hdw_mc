...
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
					...
					<div class="tab-pane card mb30" id="block_data_normal" role="tabpanel"
						aria-expanded="false">
						<div class="card-header text-uppercase">
							<div class="row mt05">
								<div class="col-md-7">
									<h4>รายการใบเบิกสถานะปกติ</h4>
								</div>
<!-- 								<div class="col-md-5"> -->
									...
									<div class="col-md-12 mb05">
										<div class="table-responsive">
											<table class="table table-bordered mb-0 table-hover">
												...
												<tbody>
													<c:forEach var="requisitionDocumentBean" items="${paginationNormal.dataListBean}" varStatus="i">
														<tr role="row">						
