...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
					...
					<div class="tab-pane card mb40 <c:if test="${invoiceSearchBean.tab eq 'C'}">active</c:if>" id="block_data_c" role="tabpanel"
						aria-expanded="true">
						<div class="card-header text-uppercase">
							<div class="row mt05">
								<div class="col-md-5">
									<h4><i class="fa fa-times-circle" style="color: red;"></i>&nbsp; ยกเลิกบิล</h4>
								</div>
								<div class="col-md-7">
						...
						<div class="posts-list posts-list-1">
							<div class="pl-item">
												...
												<tbody>
													...
													<c:choose>
														<c:when test="${pagination_c.dataListBean.size() > 0}">
															<c:forEach var="invoiceBean" items="${pagination_c.dataListBean}" varStatus="i">
														<tr>
															<td class="td-middle">
																<c:choose>
								...
								<c:if test="${pagination_c.dataListBean.size() > 0}"></c:if>
