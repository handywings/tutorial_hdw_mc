...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
					...
					<div class="tab-pane card mb40 <c:if test="${invoiceSearchBean.tab eq 'W'}">active</c:if>" id="block_data_w" role="tabpanel"
						aria-expanded="true">
						<div class="card-header text-uppercase">
							<div class="row mt05">
								<div class="col-md-5">
									<h4><i class="fa fa-hourglass-half" style="color: gray;"></i>&nbsp; รอลูกค้าชำระเงิน</h4>
								</div>
								<div class="col-md-7">
												...
												<tbody>
													...
													<c:choose>
														<c:when test="${pagination_w.dataListBean.size() > 0}">
															<c:forEach var="invoiceBean" items="${pagination_w.dataListBean}" varStatus="i">
														<tr>
															<td class="td-middle">
																<c:choose>
														...
														<c:otherwise>
															<tr><td colspan="10"><center>ไม่พบรายการใบแจ้งหนี้ที่รอลูกค้าชำระเงิน</center></td></tr>
