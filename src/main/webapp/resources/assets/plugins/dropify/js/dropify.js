...
function Dropify(element, options) {
    ...
    var defaults = {
        ...
        maxFileSize: 0,
        messages: {
            'default': 'คลิก หรือ ลากแล้ววางรูปภาพที่นี่',
            'replace': 'คลิก หรือ ลากแล้ววางรูปภาพที่นี่ เพื่อแทนที่',
            'remove':  'Remove',
            'error':   'ขออภัย , ขนาดไฟล์รูปภาพใหญ่เกินไป'
        },
        tpl: {
            wrap:        '<div class="dropify-wrapper" align="center"></div>',
            message:     '<div class="dropify-message"  align="center"><span class="file-icon" /> <p>{{ default }}</p></div>',
            preview:     '<div class="dropify-preview" align="center"><span class="dropify-render"></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="dropify-infos-message">{{ replace }}</p></div></div></div>',
            filename:    '<p class="dropify-filename" align="center"><span class="file-icon"></span> <span class="dropify-filename-inner"></span></p>',
            clearButton: '<button type="button" class="dropify-clear">{{ remove }}</button>',
            error:       '<p class="dropify-error" align="center">{{ error }}</p>'
        }
    };
