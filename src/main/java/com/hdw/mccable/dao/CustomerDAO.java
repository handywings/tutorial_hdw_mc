...
public interface CustomerDAO {
	...
	public void update(Customer company) throws Exception;
	public Long save(Customer company) throws Exception;
	public void delete(Customer company) throws Exception;
	...
	public CustomerFeature findCustomerFeatureByCustomerFeatureName(String customerFeatures);
